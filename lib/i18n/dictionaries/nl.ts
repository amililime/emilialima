...
const nl: Dict = {
  ...
  contact: {
    ...
    helper: "Antwoorden komen direct in mijn inbox.",
    send: "Versturen",
    sending: "Versturen…",
    sent: "Bericht verstuurd. Ik reageer snel.",
    error: "Kon op dit moment niet verzenden. Probeer opnieuw of mail me direct.",
  },
  footer: {
