...
const en: Dict = {
  ...
  skills: {
    ...
    groups: [
      ...
      {
        title: "AI Tooling",
        items: ["Agentic Engineering", "Claude and other AIs", "GenAI workflows"],
      },
      {
  ...
  contact: {
    ...
    helper: "Replies go straight to my inbox.",
    send: "Send",
    sending: "Sending…",
    sent: "Message sent. I'll get back to you soon.",
    error: "Couldn't send right now. Try again, or email me directly.",
  },
  footer: {
